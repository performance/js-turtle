...
演示 = () => {\n\
  ...
  改变颜色为( "yellow" );  // 黄色 \n\
  重复 (50, () => {\n\
    _此处_ 随机位置_X = 向下取整(随机值() * 1200)-600;//[-600,600]\n\
    _此处_ 随机位置_Y = 向下取整(随机值() * 450);//[0,450]\n\
    _此处_ 随机大小 = 向下取整(随机值() * 25);//[0,25]\n\
    _此处_ 随机起始角度 = 向下取整(随机值() * 90);//[0,90]\n\
    _此处_ 红 = 向下取整(随机值() * 45) + 180;//[180,225]\n\
    _此处_ 绿 = 向下取整(随机值() * 45) + 180;//[180,225]\n\
    _此处_ 随机颜色 = "#" + 红.toString(16) + 绿.toString(16) + "00";\n\

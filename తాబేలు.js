...
ఫంక్షన్ కర్వ్లెఫ్ట్ (వ్యాసార్థం, పరిధి) {
  ...
  var centerX = కుంచిక.pos.x - వ్యాసార్థం * Math.cos (కుంచిక.కోణము); // కుంచిక ఎడమ
  var centerY = కుంచిక.pos.y + వ్యాసార్థం * Math.sin (కుంచిక.కోణము);
  stopAngle = నిర్బంధించు ((startAngle - degToRad (పరిధి)), 0, 2 * Math.PI); // రేడియన్లలో CCW
  కుంచిక.కోణము = stopAngle;
  కుంచిక.pos.x = centerX + వ్యాసార్థం * Math.cos (stopAngle);
  కుంచిక.pos.y = centerY - వ్యాసార్థం * Math.sin (stopAngle);
...
ఫంక్షన్ వక్రత (వ్యాసార్థం, పరిధి) {
  ...
  var centerX = కుంచిక.pos.x + వ్యాసార్థం * Math.cos (కుంచిక.కోణము); // కుంచిక హక్కు
  var centerY = కుంచిక.pos.y - వ్యాసార్థం * Math.sin (కుంచిక.కోణము);
...
ఫంక్షన్ సర్కిల్ (వ్యాసార్థం, పరిధి, CW) {
  ...
  if (పరిధి === నిర్వచించబడలేదు) {
   imageContext.arc (కుంచిక.pos.x, కుంచిక.pos.y, వ్యాసార్థం, 0, 2 * Math.PI);
  } else ఉంటే (CW) {
    imageContext.arc (కుంచిక.pos.x, కుంచిక.pos.y, వ్యాసార్థము, -startAngle, - (startAngle + degToRad (పరిధి)), CW);
  } లేకపోతే {
    imageContext.arc (కుంచిక.pos.x, కుంచిక.pos.y, వ్యాసార్థము, -startAngle, - (startAngle-degToRad (పరిధి)), CW);
  }
...
ఫంక్షన్ లాగ్ టర్టిల్ (ఎక్కడ) {
  ...
  console.log (ఇక్కడ + "x:" + కుంచిక.pos.x + "y:" + కుంచిక.pos.y + "కోణము:" + కుంచిక.కోణము + "color:" + కుంచిక.రంగు)

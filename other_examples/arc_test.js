...
circleEyeR = (అ, ని, న, outerRadius) => {
  ...
  లెక్క_పెడుతూ_ఆవర్తించు ( న, ( చ ) => {
    ...
    కుంచికను_కింద_పెట్టు();
    వ్రాయి(చ)
    కుడివైపు_చాపము(outerRadius/2) // one inscribed circle
  } )
}
...
circleEyeL = (అ, ని, న, outerRadius) => {
  ...
  లెక్క_పెడుతూ_ఆవర్తించు ( న, ( చ ) => {
    ...
    ఎడమ_వైపు_తిరుగు(90)
    వ్రాయి(చ)
    ఎడమవైపు_చాపము(outerRadius/2); // one inscribed circle
  } )
}

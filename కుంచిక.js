...
const 存在 = ఉంది;
const 不存在 = లేదు;
const 绘制 = చిత్రీకరించు;
const 擦除 = చెరిపి_వేయి;
...
const 向左弯曲 = ఎడమవైపు_చాపాము;
const 向右弯曲 = కుడివైపు_చాపాము;
...
const 计数时重复= లెక్క_పెడుతూ_ఆవర్తించు;
const 重复 = ఆవర్తించు;

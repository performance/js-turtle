...
const बायें_चाप = ఎడమవైపు_చాపము;
const दायें_चाप = కుడివైపు_చాపము;
...
const oui = అవును;
const non = కాదు;
// const existe = ఉంది; // Same as Spanish
...
// const pause = విరామము; // already defined with same spelling
const jouer = ఆడించు;
